...
function Article() {
  ...
  return (
    <div className="w-full items-center bg-gradient-to-r from-pink-600 to-purple-500 justify-center  p-2 relative h-full  flex gap-2 relative overflow-hidden" >
      <div className="w-[70%] h-full rounded-md flex flex-col gap-3 overflow-auto mt-24 ">
      <div className="bg-black absolute h-12 w-12 top-[1%] left-[10%] border-[1px] border-primary rounded-md  text-slate-200 flex items-center justify-center">
