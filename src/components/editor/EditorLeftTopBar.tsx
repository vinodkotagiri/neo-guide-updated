...
function EditorLeftTopBar() {
  ...
  return (
    <div className='w-full h-[72px] border-slate-700 border-b-[1px] flex items-center px-4 p-2 gap-2'>
      ...
      <select className="select select-sm outline-none cursor-pointer shadow-none border-none bg-slate-900  focus:ring-0 focus:outline-none" defaultValue={1} onChange={(e)=>setOperation(parseInt(e.target.value) )}>
      ...
      <select className="select select-sm outline-none cursor-pointer shadow-none border-none bg-slate-900  focus:ring-0 focus:outline-none" defaultValue={0} onChange={(e)=>setLang(e.target.value)}>
      ...
      <select className="select select-sm outline-none cursor-pointer shadow-none border-none bg-slate-900  focus:ring-0 focus:outline-none" defaultValue={0} onChange={(e)=>setVoice(e.target.value)}>
